    ...
    <>
      <div className='bg-[#1e293b] '>
        ...
        <div className=' flex mt-6 justify-center sm:flex-col  gap-10 items-center bg-[#1e293b] text-white p-5'>
          ...
          <div className='flex flex-col gap-3  pl-10 sm:w-80 sm:pl-3 '>
            ...
            <div className=''>
              <p className='p-2 mb-5 text-2xl font-bold opacity-100 w-40'>Top Cast</p>
              {
                !isLoading ? <>
                  <div className='flex w-96 sm:w-72 flex-wrap sm:h-80 sm:justify-center gap-5 h-32 overflow-hidden '>
                    {
