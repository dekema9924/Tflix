  ...
  useEffect(() => {
    axios.get(`http://localhost:3000/routes/api/details/${id}`)
      .then((response) => {
        ...
        setLoading(false)
        console.log(isDetails.backdrop_path)
        // console.log(isDetails.genres)
      })
  }, [])
  ...
  return (
    <>
      <div className='bg-[#1e293b] '>
        ...
        <div className=' flex  justify-center sm:flex-col  gap-4 items-center bg-[#1e293b] text-white p-5'  >
